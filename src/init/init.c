...
/*   init.c                                             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: diachoug <diachoug@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/08/30 22:48:03 by mgrager           #+#    #+#             */
/*   Updated: 2026/09/20 18:09:04 by diachoug         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	mlx_hook(game->win, 17, 0, (int (*)(void))(void *)close_win, game);
	mlx_hook(game->win, 2, 1L << 0, (int (*)(void))(void *)key_press, game);
	mlx_hook(game->win, 3, 1L << 1, (int (*)(void))(void *)key_release, game);
	if (BONUS)
	{
		mlx_hook(game->win, 4, 1L << 2, (int (*)(void))(void *)scroll_hook, game);
		mlx_hook(game->win, 6, 1L << 6, (int (*)(void))(void *)mouse_hook, game);
	}
}
